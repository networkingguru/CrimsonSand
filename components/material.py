...
m_cloth = Material(name='Cloth', hardness=.4, elasticity=.3, toughness=6, normality=2, cost=12, density=.01, p_ratio = .5, craft_diff = 1)
m_canvas = Material(name='Canvas', hardness=.7, elasticity=.5, toughness=9, normality=1.5, cost=15, density=.015, p_ratio = .48, craft_diff = 1)
m_leather = Material(name='Leather', hardness=.6, elasticity=.5, toughness=8, normality=2, cost=14, density=.05, p_ratio = .47, craft_diff = .3)
m_bleather = Material(name='Boiled Leather', hardness=.9, elasticity=.9, toughness=6, normality=1, cost=18, density=.07, p_ratio = .45, craft_diff = .4)
m_hide = Material(name='Hide', hardness=.6, elasticity=.8, toughness=8, normality=2, cost=10, density=.05, p_ratio = .2, craft_diff = .1)
m_xthide = Material(name='Exotic Thick Hide', hardness=1, elasticity=.9, toughness=8, normality=.5, cost=20, density=.08, p_ratio = .47, craft_diff = .4)
