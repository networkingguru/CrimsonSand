...
m_cloth = Material(name='Cloth', hardness=.1, elasticity=.2, toughness=8, normality=2, cost=12, density=.1, p_ratio = .5, craft_diff = 1)
m_canvas = Material(name='Canvas', hardness=.15, elasticity=.5, toughness=9, normality=1.5, cost=15, density=.2, p_ratio = .48, craft_diff = 1)
m_leather = Material(name='Leather', hardness=.3, elasticity=.6, toughness=8, normality=2, cost=14, density=.2, p_ratio = .47, craft_diff = .3)
m_bleather = Material(name='Boiled Leather', hardness=.5, elasticity=.8, toughness=6, normality=1, cost=18, density=.2, p_ratio = .45, craft_diff = .4)
m_hide = Material(name='Hide', hardness=.3, elasticity=.8, toughness=8, normality=2, cost=10, density=.25, p_ratio = .47, craft_diff = .1)
m_xthide = Material(name='Exotic Thick Hide', hardness=.5, elasticity=.9, toughness=8, normality=.5, cost=20, density=.5, p_ratio = .47, craft_diff = .4)
m_wood = Material(name='Wood', hardness=1, elasticity=1, toughness=1, normality=2, cost=1, density=1, p_ratio = .47, craft_diff = .1)
m_bone = Material(name='Bone', hardness=1.3, elasticity=1.8, toughness=.7, normality=2, cost=5, density=.8, p_ratio = .4, craft_diff = .2)
